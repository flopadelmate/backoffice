...
function evidenceQ2(answer: AnswerQ2): Evidence {
  const map: Record<AnswerQ2, Evidence> = {
    "moins-1an":  { mu: 1.5, tau: 2.0, weight: 0.9, hardMax: 4.0 },
    "1-3ans":     { mu: 2.8, tau: 1.5, weight: 0.9, hardMax: 5.5 },
    "3-6ans":     { mu: 3.5, tau: 1.2, weight: 0.8, hardMax: 6.5 },
    "6-10ans":    { mu: 3.8, tau: 1.3, weight: 0.6 },
    "plus-10ans": { mu: 4.2, tau: 1.5, weight: 0.5 },
  };
  return map[answer];
}
...
function evidenceQ3(answer: AnswerQ3): Evidence {
  const map: Record<AnswerQ3, Evidence> = {
    "loisir":                { mu: 1.1, tau: 3.0, weight: 0.2 },
    "debut-competition":     { mu: 3.8, tau: 1.0, weight: 1.0 },
    "competiteur-regulier":  { mu: 5.5, tau: 0.8, weight: 1.0 },
    "competiteur-avance":    { mu: 7.5, tau: 0.7, weight: 1.0 },
  };
  return map[answer];
}
...
function evidenceQ4(answer: AnswerQ4): Evidence {
  const map: Record<AnswerQ4, Evidence> = {
    "1": { mu: 1.1, tau: 1.2, weight: 0.9, hardMax: 3.0 },
    "2": { mu: 2.5, tau: 1.2, weight: 1.0, hardMax: 4.0 },
    "3": { mu: 3.8, tau: 1.3, weight: 1.0, hardMax: 5.0 },
    "4": { mu: 5.0, tau: 1.3, weight: 1.1 },
    "5": { mu: 6.0, tau: 1.4, weight: 1.1 },
  };
  return map[answer];
}
...
function evidenceQ5(answer: AnswerQ5): Evidence {
  const map: Record<AnswerQ5, Evidence> = {
    "1": { mu: 1.0, tau: 1.2, weight: 1.0, hardMax: 3.0 },
    "2": { mu: 2.5, tau: 1.2, weight: 1.0, hardMax: 4.0 },
    "3": { mu: 3.8, tau: 1.3, weight: 1.0, hardMax: 5.0 },
    "4": { mu: 5.0, tau: 1.3, weight: 1.1 },
    "5": { mu: 6.0, tau: 1.4, weight: 1.1 },
